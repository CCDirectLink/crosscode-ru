...
const LEA_SPELLING_CONVERSION_TABLES = new Map<string, Map<string, string>>([
  [
    ...
    new Map([
      ...
      ['ЛЕЕЙ', 'ЛИЕЙ'],
      ['Манлея', 'Манлиа'], // Именительный (1)
      ['МАНЛЕЯ', 'МАНЛИА'],
      ['Манлеи', 'Манлии'], // Родительный (2)
      ['МАНЛЕИ', 'МАНЛИИ'],
      ['Манлее', 'Манлие'], // Дательный (3) + Предложный (6)
      ['МАНЛЕЕ', 'МАНЛИЕ'],
      ['Манлею', 'Манлию'], // Винительный (4)
      ['МАНЛЕЮ', 'МАНЛИЮ'],
      ['Манлеей', 'Манлией'], // Творительный (5)
      ['МАНЛЕЕЙ', 'МАНЛИЕЙ'],
    ]),
  ],
]);
